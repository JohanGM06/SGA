...
class Certificados_PDF
{
  ...
  public function Certificado_laboral()
  {
    ...
    $html = '
            ...
            <body>
            <img src="assets/img/certificado_laboral/encabezado.PNG" class="header-image">
            <br>
            <br>
            <br>
            <br>
            ...
            <div class="final">
                    Cordialmente:
                <br> 
                <img src = "assets/img/certificado_laboral/firma.PNG">    
                <br> 
            ...
            <img src="assets/img/certificado_laboral/pie.PNG" class="bottomcenter"/>
            </body>
            </html>
    ...
    $dompdf->stream('Certificado Laboral ' . $nombres . '.pdf', array('Attachment' => 0));
  }
  ...
  public function Certificado_permisos()
  {
    ...
    $html = '
        ...
        <body>
              <img src="assets/img/certificado_permisos/form.PNG" class="center"/> 
